...
__root  const  APP_INTVECT_ELEM  __vector_table[] @ ".intvec" = {
    ...
    App_Spurious_ISR,                                           /* 59, INTISR[ 43]  Reserved.                           */
    App_Spurious_ISR,                                           /* 60, INTISR[ 44]  Reserved.                           */
    App_Spurious_ISR,                                           /* 61, INTISR[ 45]  Reserved.                           */
    App_Spurious_ISR,                                           /* 62, INTISR[ 46]  Reserved.                           */
    App_Spurious_ISR,                                           /* 63, INTISR[ 47]  Reserved.                           */
    App_Spurious_ISR,                                           /* 64, INTISR[ 48]  Reserved.                           */
    App_Spurious_ISR,                                           /* 65, INTISR[ 49]  Reserved.                           */
    
    BSP_IntHandlerTIM5,                                         /* 66, INTISR[ 50]  TIM5 Global Interrupt.              */
    BSP_IntHandlerSPI3,                                         /* 67, INTISR[ 51]  SPI3 Global Interrupt.              */
    BSP_IntHandlerUSART4,                                       /* 68, INTISR[ 52]  USART4 Global Interrupt.            */
    BSP_IntHandlerUSART5,                                       /* 69, INTISR[ 53]  USART5 Global Interrupt.            */
    BSP_IntHandlerTIM6,                                         /* 70, INTISR[ 54]  TIM6 Global Interrupt.              */
    BSP_IntHandlerTIM7,                                         /* 71, INTISR[ 55]  TIM7 Global Interrupt.              */    
    BSP_IntHandlerDMA2_CH1,                                     /* 72, INTISR[ 56]  DMA Channel2 Global Interrupt.      */
    BSP_IntHandlerDMA2_CH2,                                     /* 73, INTISR[ 57]  DMA Channel2 Global Interrupt.      */
    BSP_IntHandlerDMA2_CH3,                                     /* 74, INTISR[ 58]  DMA Channel2 Global Interrupt.      */
    BSP_IntHandlerDMA2_CH4,                                     /* 75, INTISR[ 59]  DMA Channel2 Global Interrupt.      */
    BSP_IntHandlerDMA2_CH5,                                     /* 76, INTISR[ 60]  DMA Channel2 Global Interrupt.      */
    
    BSP_IntHandlerETH,                                          /* 77, INTISR[ 61]  Ethernet Global Interrupt.          */
    BSP_IntHandlerETHWakeUp,                                    /* 78, INTISR[ 62]  Ethernet Wakeup Interrupt.          */
    ...
    BSP_IntHandlerUSB,                                          /* 83, INTISR[ 67]  USB OTG FS Interrupt.               */   
};
